...
(function (root, factory) {
  ...
  var // tests that it is a date string, not a valid date. 88/88/8888 would be true
  ...
  function isValidObject(date) {
    ...
    if (_typeof(date) === 'object' && date instanceof Date) {
      ms = date.getTime();
    ...
    switch (_typeof(value)) {
      ...
      case 'string':
        ...
        if (parts && parts[2] === parts[4]) {
          month = +parts[1];
          day = +parts[3];
          year = +parts[5]; // rough check of a year

          if (0 < year && year < 2100 && 1 <= month && month <= 12 && 1 <= day && day <= (month === 2 && isLeapYear(year) ? 29 : monthLengths[month - 1])) {
            return true;
          }
        ...
        if (parts) {
          ...
          if (0 < year && year < 2100 && 1 <= month && month <= 12 && 1 <= day && day <= (month === 2 && isLeapYear(year) ? 29 : monthLengths[month - 1]) && hours < 24 && minutes < 60 && seconds < 60) {
            return true;
          }
        }
  ...
  function getNaturalDay(date, compareDate, noDaysOfWeek) {
    var today = compareDate || new Date(),
  ...
  function fromTimestamp(str) {
    ...
    str = str.split('Z')[0]; // ["2000-02-30T00:00:00", "2000", "02", "30", "00", "00", "00", index: 0, input: "2000-02-30T00:00:00"]

    var parts = tsRegExp.exec(str); // TODO: do we need a validation?
  ...
  dates = {
    ...
    isDateType: function isDateType(item) {
...
function (_BaseComponent) {
  ...
  _createClass(DateInput, [{
    ...
    get: function get() {
      return props.concat(bools, ['value']);
    }
  }]);
  ...
  function DateInput() {
    ...
    _this = _possibleConstructorReturn(this, (DateInput.__proto__ || Object.getPrototypeOf(DateInput)).call(this));
    _this.showing = false;
    return _this;
  }
...
},{"./date-picker":11,"@clubajax/base-component":2,"@clubajax/dom":7,"@clubajax/on":8,"dates":9}],11:[function(require,module,exports){
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var dom = require('@clubajax/dom'); // TODO:
// https://axesslab.com/accessible-datepickers/


var props = ['min', 'max']; // range-left/range-right mean that this is one side of a date-range-picker
...
function (_BaseComponent) {
  ...
  function DatePicker() {
    ...
    _this = _possibleConstructorReturn(this, (DatePicker.__proto__ || Object.getPrototypeOf(DatePicker)).call(this));
...
},{"@clubajax/base-component":2,"@clubajax/dom":7,"dates":9}],12:[function(require,module,exports){
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_DateInput) {
  ...
  function DateRangeInput() {
    ...
    _this = _possibleConstructorReturn(this, (DateRangeInput.__proto__ || Object.getPrototypeOf(DateRangeInput)).call(this));
...
},{"./date-input":10,"./date-range-picker":14,"dates":9}],13:[function(require,module,exports){
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_BaseComponent) {
  ...
  _createClass(DateRangeInputs, [{
    ...
    get: function get() {
      ...
      return "".concat(this.leftInput.value).concat(DELIMITER).concat(this.rightInput.value);
    }
  }, {
    key: "values",
    get: function get() {
  ...
  function DateRangeInputs() {
    ...
    _this = _possibleConstructorReturn(this, (DateRangeInputs.__proto__ || Object.getPrototypeOf(DateRangeInputs)).call(this));
...
},{"./date-input":10,"@clubajax/base-component":2,"@clubajax/dom":7,"dates":9}],14:[function(require,module,exports){
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_BaseComponent) {
  ...
  _createClass(DateRangePicker, [{
    ...
    value: function onValue(value) {
      ...
      onDomReady(this, function () {
        _this.setValue(_this.strDate, true);
      });
    }
  }, {
    key: "props",
  ...
  _createClass(DateRangePicker, [{
    ...
    key: "domReady",
    value: function domReady() {
      this.leftCal = dom('date-picker', {
        'range-left': true
      }, this);
      this.rightCal = dom('date-picker', {
        'range-right': true
      }, this);
      this.rangeExpands = this['range-expands'];
      this.connectEvents(); // if (this.initalValue) {
...
},{"./date-picker":11,"@clubajax/base-component":2,"@clubajax/dom":7,"dates":9}],15:[function(require,module,exports){
require('./globals');
...
},{"../../src/date-input":10,"../../src/date-picker":11,"../../src/date-range-input":12,"../../src/date-range-inputs":13,"../../src/date-range-picker":14,"./globals":16}],16:[function(require,module,exports){
